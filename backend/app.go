...
func (a *App) Handler() http.Handler {
	...
	mux.HandleFunc("PUT /api/admin/users/{id}/services", a.setUserServicesHandler)
	...
	mux.HandleFunc("POST /api/ereport/orgs/{orgId}/reports/{reportId}/history", a.ereportCreateHistoryHandler)
	...
	mux.HandleFunc("GET /api/ereport/shared", a.ereportListSharedHandler)
	mux.HandleFunc("GET /api/ereport/shared/orgs/{orgId}/reports/{reportId}", a.ereportGetSharedReportHandler)
	mux.HandleFunc("PUT /api/ereport/shared/orgs/{orgId}/reports/{reportId}", a.ereportPutSharedReportHandler)
	mux.HandleFunc("POST /api/ereport/shared/orgs/{orgId}/reports/{reportId}/images", a.ereportSharedUploadImageHandler)
	mux.HandleFunc("GET /api/ereport/shared/orgs/{orgId}/reports/{reportId}/images/{imageId}", a.ereportSharedGetImageHandler)
	...
	mux.HandleFunc("POST /api/ereport/invites/{inviteId}/claim", a.ereportInviteClaimHandler)
	...
	mux.HandleFunc("POST /api/v1/epam/epams", a.withAPIKey(productEpam, a.epamV1CreateHandler))
	mux.HandleFunc("PUT /api/v1/epam/epams/{id}", a.withAPIKey(productEpam, a.epamV1UpdateHandler))
