...
func (a *App) Handler() http.Handler {
	...
	mux.HandleFunc("GET /api/v1/ereport/orgs/{orgId}/reports/{reportId}/executions", a.withAPIKey(productEreport, a.ereportV1ListExecutionsHandler))
	mux.HandleFunc("POST /api/v1/ereport/orgs/{orgId}/reports/{reportId}/executions", a.withAPIKey(productEreport, a.ereportV1PostExecutionHandler))
	mux.HandleFunc("GET /api/v1/ereport/orgs/{orgId}/reports/{reportId}/executions/index", a.withAPIKey(productEreport, a.ereportV1GetExecutionIndexHandler))
	mux.HandleFunc("GET /api/v1/ereport/orgs/{orgId}/reports/{reportId}/executions/status", a.withAPIKey(productEreport, a.ereportV1GetExecutionStatusHandler))
	mux.HandleFunc("GET /api/v1/ereport/orgs/{orgId}/reports/{reportId}/executions/identity", a.withAPIKey(productEreport, a.ereportV1GetExecutionIdentityHandler))
	mux.HandleFunc("PUT /api/v1/ereport/orgs/{orgId}/reports/{reportId}/executions/identity", a.withAPIKey(productEreport, a.ereportV1PutExecutionIdentityHandler))
	mux.HandleFunc("GET /api/v1/ereport/orgs/{orgId}/reports/{reportId}/executions/{executionId}", a.withAPIKey(productEreport, a.ereportV1GetExecutionHandler))
	mux.HandleFunc("GET /api/v1/ereport/orgs/{orgId}/reports/{reportId}/executions/{executionId}/ereport-append-items", a.withAPIKey(productEreport, a.ereportV1ExecutionToAppendItemsHandler))
